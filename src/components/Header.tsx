...
const Header = () => {
  return (
    <header className="container mx-auto flex justify-between items-center gap-3 bg-gray-100 border-2 rounded-lg p-2">
      ...
      <nav>
        <ul className="flex justify-center items-center lg:gap-6 sm:gap-3 gap-1 sm:me-8">
          <li>
            <Link
              to="/"
              className="block hover:text-lime-600/80 transion-all rounded-full sm:p-2 p-1"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
