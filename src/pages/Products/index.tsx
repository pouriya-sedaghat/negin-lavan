      ...
      <div className="flex justify-start">
        <div className="relative group w-full sm:max-w-xs md:max-w-sm">
          ...
          <button
            ...
            className={`absolute left-2.5 top-1/2 -translate-y-1/2 w-4 h-4 rounded-full bg-gray-200 hover:bg-gray-300 text-gray-400 flex items-center justify-center transition-all duration-150 ${
            ...
            >
              ...
              >
                <div className="w-full aspect-square p-1 pb-0">
                  <img
                    src={`/images/products/shades/borders/shade-solara-one.png`}
                    alt={product.title}
                    className="w-full h-full object-contain"
                    draggable={false}
                  />
